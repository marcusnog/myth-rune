...
const SOURCE_PATH = path.join(ROOT, '04.png');
...
const OUTPUT_ROOT = path.join(PUBLIC_MAP_DIR, 'nanobanana_04');
const DIST_OUTPUT_ROOT = path.join(DIST_MAP_DIR, 'nanobanana_04');
...
const HYBRID_OUTPUT_NAME = 'tileset_04_safe_hybrid.png';
